...
namespace Msg
{
    public partial class MsgBox : Form
    {
        ...
        public MsgBox(string pTipo, string pMensaje)
        {
            ...
            {
                case "question":
                    lblTitulo.Text = "IMC - Saludable";//Cambiamos el label titulo
                    ...
                    break;
                case "warning":
                    lblTitulo.Text = "IMC - advertencia";//Cambiamos el label titulo
                    ...
                    break;
                case "error":
                    lblTitulo.Text = "IMC - Peligro";//Cambiamos el label titulo

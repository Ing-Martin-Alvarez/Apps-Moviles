...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "PasarDatosAOtroFormulario.Android.dll" comes first in this list. */
		"PasarDatosAOtroFormulario.Android.dll",
		"FormsViewGroup.dll",
		"PasarDatosAOtroFormulario.dll",
